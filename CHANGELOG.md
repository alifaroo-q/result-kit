...
- 75e5910: `combine` and `combineWithAllErrors` accept a **record**, and the not-a-`Result` diagnostic now names where it failed — on the array path too.
