...
- **Date:** 2026-07-14
- **Deciders:** Ali Farooq
- **Ticket:** [Decide: the v2 Result type shape](https://github.com/alifaroo-q/result-kit/issues/12)
...
- These are the **root** `@zireal/result-kit` plain-union constructors. The `@zireal/result-kit/fluent` entrypoint's wrapping `ok` / `err` (returning the wrapper) are [#15](https://github.com/alifaroo-q/result-kit/issues/15) / [#13](https://github.com/alifaroo-q/result-kit/issues/13)'s concern.
...
- **[#13](https://github.com/alifaroo-q/result-kit/issues/13) is now unblocked** — the API surface / method inventory can lock every function signature against this concrete union shape. **[#15](https://github.com/alifaroo-q/result-kit/issues/15)** (package layout) consumes the root-vs-`/fluent` constructor split.
